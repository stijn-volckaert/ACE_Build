...
copy ..\ACE\System\Client_NonSSE.dll ACEv12d_C_NonSSE.dll
copy ..\ACE\System\Client_SSE_SSE2.dll ACEv12d_C_SSE_SSE2.dll
copy ..\ACE\System\Client_SSE_SSE2_AVX_AVX2.dll ACEv12d_C_SSE_SSE2_AVX_AVX2.dll
...
..\PortableJava\bin\java -jar AnthObfuscator.jar ACEv12d_C.u -s -n -o
del ACEv12d_C.u
rename ACEv12d_C_obfuscated.u ACEv12d_C.u
