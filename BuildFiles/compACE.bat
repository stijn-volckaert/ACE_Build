...
copy ..\ACE\System\Client_NonSSE.dll ACEv12c_C_NonSSE.dll
copy ..\ACE\System\Client_SSE_SSE2.dll ACEv12c_C_SSE_SSE2.dll
copy ..\ACE\System\Client_SSE_SSE2_AVX_AVX2.dll ACEv12c_C_SSE_SSE2_AVX_AVX2.dll
...
..\PortableJava\bin\java -jar AnthObfuscator.jar ACEv12c_C.u -s -n -o
del ACEv12c_C.u
rename ACEv12c_C_obfuscated.u ACEv12c_C.u
